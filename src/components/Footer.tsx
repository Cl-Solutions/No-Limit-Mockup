...
function DatenschutzModal({ onClose }: { onClose: () => void }) {
  return (
    ...
    >
      <div
        className="bg-[#111] border border-white/10 rounded-sm max-w-2xl w-full max-h-[80vh] overflow-y-auto p-10"
        onClick={(e) => e.stopPropagation()}
      >
        <h2 className="text-white font-black text-2xl mb-6">Datenschutzerklärung</h2>
        <div className="text-white/60 text-sm leading-relaxed space-y-4">
          ...
          <p>
            <strong className="text-white">Erhebung personenbezogener Daten:</strong><br />
          ...
          <p>
            <strong className="text-white">Kontaktformular:</strong><br />
          ...
          <p>
            <strong className="text-white">Ihre Rechte:</strong><br />
  ...
  return (
    ...
    >
      <div
        ...
        onClick={(e) => e.stopPropagation()}
      >
        <h2 className="text-white font-black text-2xl mb-6">Impressum</h2>
        <div className="text-white/60 text-sm leading-relaxed space-y-4">
          <p>
            <strong className="text-white">Angaben gemäß § 5 TMG:</strong><br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              <div className="flex flex-col items-start mb-4">
                ...
                <span className="text-white text-3xl font-black tracking-tight">NoLimit</span>
              </div>
            ...
            <div>
              <h4 className="text-white font-bold text-xs uppercase tracking-[0.2em] mb-5">Navigation</h4>
              <div className="grid grid-cols-2 gap-2">
                {navLinks.map((link) => (
                  <button
                    key={link.href}
                    onClick={() => handleNav(link.href)}
                    className="text-gray-300 hover:text-white text-sm text-left transition-colors hover:pl-1 duration-200"
                  >
                    {link.label}
                  </button>
                ))}
            ...
            <div>
              <h4 className="text-white font-bold text-xs uppercase tracking-[0.2em] mb-5">Kontakt</h4>
