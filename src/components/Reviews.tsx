      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <a
            ...
            aria-label={`Alle ${REVIEW_COUNT} Google-Bewertungen ansehen`}
            className="flex items-center gap-5 bg-paper-subtle dark:bg-ink-surface border border-black/8 dark:border-white/8 rounded-sm px-6 py-5 shrink-0 group hover:border-brand/50 hover:bg-paper-muted dark:hover:bg-ink-inset transition-[border-color,background-color,transform] duration-150 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-fg-muted dark:text-white/55 text-xs mt-1 flex items-center gap-1">
                <span>aus {REVIEW_COUNT} Bewertungen</span>
                <span aria-hidden="true" className="text-brand font-bold group-hover:translate-x-0.5 transition-transform">→</span>
              </div>
            </div>
          </a>
        </motion.div>
